#####################
#   set seed to have at least some reproducibility in keras
#####################
seed_value= 0
...
######################
#   Shallow VAE (use model found in VAE)
######################
# DEFINE THE ENCODER LAYERS
input_dim = Input(shape = (19147, ))
...
decoded4 = Dense(19147, activation = 'sigmoid')(decoded3)
...
history  = autoencoder.fit(X, X, epochs = 1000, callbacks=callbacks, batch_size = 32, shuffle = True)

# THE ENCODER TO EXTRACT THE REDUCED DIMENSION FROM THE ABOVE AUTOENCODER
encoder = Model(input_dim, z, name='encoder')
encoder.summary()
encoded_input = Input(shape = (19147, ))
