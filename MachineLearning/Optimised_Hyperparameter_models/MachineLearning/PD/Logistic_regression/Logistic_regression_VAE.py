...
#Model #200
#Best pr-AUC: 0.5299
#Best params: OrderedDict([('C', 0.0004564858908057899)])


############
#	Run the model
############
clf = LogisticRegression(C= 0.0004564858908057899 , random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
...
#           0      0.653     0.721     0.685        68
#           1      0.661     0.587     0.622        63
#    accuracy                          0.656       131
#   macro avg      0.657     0.654     0.654       131
#weighted avg      0.657     0.656     0.655       131
