...
#Model #100
#Best pr-AUC: 0.5916
#Best params: OrderedDict([('max_depth', 9), ('min_samples_leaf', 14)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 14),
    search_spaces = {
...
#Model #100
#Best pr-AUC: 0.5833
#Best params: OrderedDict([('n_estimators', 559)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 14, n_estimators = 559),
    search_spaces = {
...
estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 14, n_estimators = 559, min_samples_split = 15, max_features = 'log2')
...
#0.561373758721496
estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 14, n_estimators = 559, min_samples_split = 15, max_features = 'sqrt')
np.mean(cross_val_score(estimator, X_train, y_train, cv = StratifiedKFold(n_splits=5, shuffle = True, random_state=15), scoring = 'average_precision'))
#0.5834386866732922
...
#	Run the model
############
clf = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 14, n_estimators = 559, min_samples_split = 15, max_features = 'sqrt')
...
#           0      0.675     0.824     0.742        68
#           1      0.750     0.571     0.649        63
#    accuracy                          0.702       131
#   macro avg      0.712     0.697     0.695       131
#weighted avg      0.711     0.702     0.697       131
