...
#Model #200
#Best pr-AUC: 0.8006
#Best params: OrderedDict([('C', 0.7574549571884588), ('gamma', 0.0055964161508459806)])


############
#	Run the model
############
clf = SVC(kernel='rbf', probability=True, C= 0.7574549571884588, gamma = 0.0055964161508459806, random_state=142, class_weight = 'balanced')
