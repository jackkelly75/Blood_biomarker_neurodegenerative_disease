...
#Model #200
#Best pr-AUC: 0.5736
#Best params: OrderedDict([('C', 0.9913923918529673), ('gamma', 0.00557410160139167)])


############
#	Run the model
############
clf = SVC(kernel='rbf', probability=True, C= 0.9913923918529673, gamma = 0.00557410160139167, random_state=142, class_weight = 'balanced')
