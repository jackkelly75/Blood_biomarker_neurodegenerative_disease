...
Model #200
Best pr-AUC: 0.6977
Best params: OrderedDict([('C', 5148.861846035081), ('gamma', 0.000670158510611821)])


############
#	Run the model
############
clf = SVC(kernel='rbf', probability=True, C= 5148.861846035081, gamma = 0.000670158510611821, random_state=142, class_weight = 'balanced')
...
#           0      0.618     0.809     0.701        68
#           1      0.690     0.460     0.552        63
#    accuracy                          0.641       131
#   macro avg      0.654     0.635     0.627       131
#weighted avg      0.653     0.641     0.629       131


############
#	Plot the model evaluation
############
os.chdir('/home/jack11/Desktop/PD_ML_final/5_ML/2_SVM')
...
pl.savefig('SVM_ROC_bayesian_VSSRFE+LR.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('SVM_prAUC_bayesian_VSSRFE+LR.png', dpi = 2000)
