...
#Model #100
#Best pr-AUC: 1.0
#Best params: OrderedDict([('C', 1.1877734194503269), ('gamma', 0.0006219073574834002)])

#####################
#   Run the model
#####################
clf = SVC(kernel='rbf', probability=True, C=  1.1877734194503269, gamma = 0.0006219073574834002,  random_state=142, class_weight = 'balanced')
...
#           0      0.692     0.712     0.701       104
#           1      0.786     0.769     0.777       143
#    accuracy                          0.745       247
#   macro avg      0.739     0.740     0.739       247
#weighted avg      0.746     0.745     0.745       247
...
pl.savefig('SVM_ROC_bayesian_VSSRFE_LR.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('SVM_prAUC_bayesian_VSSRFE_LR.png', dpi = 2000)
