...
#Model #50
#Best pr-AUC: 0.9253
#Best params: OrderedDict([('max_depth', 9), ('min_samples_leaf', 1)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 1),
    search_spaces = {
...
#Model #100
#Best pr-AUC: 0.9329
#Best params: OrderedDict([('n_estimators', 4178)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 1, n_estimators = 4178),
    search_spaces = {
...
#Model #20
#Best pr-AUC: 0.9329
#Best params: OrderedDict([('min_samples_split', 2)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 1, n_estimators = 4178, min_samples_split = 2),
    search_spaces = {
        'max_features': (1, 159, 'uniform')
    },    
    cv = StratifiedKFold(
        n_splits=5,
        shuffle = True,
...
#Model #10
#Best pr-AUC: 0.9297
#Best params: OrderedDict([('max_features', 15)])


#####################
#   Run the model
#####################
clf = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 9, min_samples_leaf = 1, n_estimators = 4178, min_samples_split = 2, max_features = 15)
...
#           0      0.761     0.798     0.779       104
#           1      0.848     0.818     0.833       143
#    accuracy                          0.810       247
#   macro avg      0.805     0.808     0.806       247
#weighted avg      0.811     0.810     0.810       247
