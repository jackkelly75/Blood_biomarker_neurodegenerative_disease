...
#Model #50
#Best pr-AUC: 0.7503
#Best params: OrderedDict([('max_depth', 2), ('min_samples_leaf', 13)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 2, min_samples_leaf = 13),
    search_spaces = {
...
#Model #100
#Best pr-AUC: 0.7636
#Best params: OrderedDict([('n_estimators', 451)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 2, min_samples_leaf = 13, n_estimators = 451),
    search_spaces = {
...
estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 2, min_samples_leaf = 13, n_estimators = 451, min_samples_split = 15, max_features = 'log2')
...
#0.717602552769324
estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 2, min_samples_leaf = 13, n_estimators = 451, min_samples_split = 15, max_features = 'sqrt')
np.mean(cross_val_score(estimator, X_train, y_train, cv = StratifiedKFold(n_splits=5, shuffle = True, random_state=15), scoring = 'average_precision'))
#0.7638424050342699
...
#   Run the model
#####################
clf = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 2, min_samples_leaf = 13, n_estimators = 451, min_samples_split = 15, max_features = 'sqrt')
...
#           0      0.636     0.673     0.654       104
#           1      0.752     0.720     0.736       143
#    accuracy                          0.700       247
#   macro avg      0.694     0.697     0.695       247
#weighted avg      0.703     0.700     0.701       247
