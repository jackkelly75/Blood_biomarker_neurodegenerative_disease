...
#Model #100
#Best pr-AUC: 0.7634
#Best params: OrderedDict([('C', 0.00045526282090663776)])


##########
# Run the model
##########
clf = LogisticRegression(C =0.00045526282090663776, random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
...
#           0      0.710     0.635     0.670       104
#           1      0.753     0.811     0.781       143
#    accuracy                          0.737       247
#   macro avg      0.731     0.723     0.726       247
#weighted avg      0.735     0.737     0.734       247
