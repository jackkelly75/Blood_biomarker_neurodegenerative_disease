...
######################
#   train VAE for feature selection
######################
# DEFINE THE ENCODER LAYERS
feature_num = len(X_train.columns)

input_dim = Input(shape = (feature_num, ))
...
decoded4 = Dense(feature_num, activation = 'sigmoid')(decoded3)
...
encoded_input = Input(shape = (feature_num, ))
temp = encoder.predict(X_train)
encoded_out = encoder.predict(X_test)
encoded_out


#save the new test and train datasets as pickle files
