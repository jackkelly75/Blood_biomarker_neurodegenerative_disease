...
#################################
#   reshape the data to image input
#################################
# below is example of dataset with 20183 features
x_train = X_train.values
#add 0s to the end of the train to make it divisible by 100
...
#	Best Model
####################
#once best model is found using grid search above
...
print(metrics.classification_report(y_test[:,1], np.round(y_pred_keras[:,1]))) 
