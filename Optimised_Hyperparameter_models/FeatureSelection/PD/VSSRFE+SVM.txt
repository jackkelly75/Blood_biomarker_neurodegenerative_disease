...
#Model #200
#Best pr-AUC: 0.585
#Best params: OrderedDict([('C', 0.013957862670218063)])
...
def VSSRFE(n_genes):
    ...
    N = n_total
    S = s_initial
    clf = LinearSVC(penalty='l1',loss='squared_hinge',C=0.013957862670218063,dual=False,fit_intercept=True,random_state=1, max_iter  = 50000,  class_weight='balanced')
    while N > n_selected:
        N = N-S
        if temp/N>2 and S>1:
            temp=N
