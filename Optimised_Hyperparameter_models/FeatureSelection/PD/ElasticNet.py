...
################################
# Tune ElasticNet model using bayesian optimisation
################################
...
#Model #200
#Best pr-AUC: 0.5865
#Best params: OrderedDict([('alpha', 0.11706340940735029), ('l1_ratio', 0.6224924705507516)])
...
sel_ = SelectFromModel(ElasticNet(random_state=1, max_iter = 5000, alpha = 0.11706340940735029, l1_ratio = 0.6224924705507516))
...
#save train and test datasets with only selected features
