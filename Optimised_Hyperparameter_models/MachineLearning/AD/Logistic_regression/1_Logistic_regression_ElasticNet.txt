...
#Model #100
#Best pr-AUC: 0.9688
#Best params: OrderedDict([('C', 0.04732507501344494)])
...
# Run the model
##########
clf = LogisticRegression(C=0.04732507501344494  , random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
...
#           0      0.636     0.721     0.676       104
#           1      0.775     0.699     0.735       143
#    accuracy                          0.709       247
#   macro avg      0.705     0.710     0.705       247
#weighted avg      0.716     0.709     0.710       247
