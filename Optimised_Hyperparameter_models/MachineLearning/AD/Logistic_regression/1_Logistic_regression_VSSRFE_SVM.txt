...
#Model #100
#Best pr-AUC: 0.8327
#Best params: OrderedDict([('C', 0.10533408514169781)])


##########
# Run the model
##########
clf = LogisticRegression(C = 0.10533408514169781, random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
...
#           0      0.725     0.760     0.742       104
#           1      0.819     0.790     0.804       143
#    accuracy                          0.777       247
#   macro avg      0.772     0.775     0.773       247
#weighted avg      0.779     0.777     0.778       247
...
pl.savefig('LogisticRegression_ROC_bayesian_VSSRFE_SVM.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('LogisticRegression_prAUC_bayesian_VSSRFE_SVM.png', dpi = 2000)
