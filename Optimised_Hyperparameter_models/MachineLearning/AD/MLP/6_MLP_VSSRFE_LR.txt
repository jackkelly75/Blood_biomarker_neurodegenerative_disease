...
#   Run the model
#####################
clf = MLPClassifier(alpha = 0.0001, activation = 'relu', hidden_layer_sizes=(100, ), solver = 'lbfgs', verbose=10,  random_state=10, max_iter = 1000)
...
#           0      0.720     0.692     0.706       104
#           1      0.782     0.804     0.793       143
#    accuracy                          0.757       247
#   macro avg      0.751     0.748     0.749       247
#weighted avg      0.756     0.757     0.756       247
