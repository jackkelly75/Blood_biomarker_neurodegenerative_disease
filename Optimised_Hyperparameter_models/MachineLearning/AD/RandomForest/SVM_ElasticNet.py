...
#Model #100
#Best pr-AUC: 0.9706
#Best params: OrderedDict([('C', 3.251126178797826), ('gamma', 0.0034279054890762506)])


#####################
#   Run the model
#####################
clf = SVC(kernel='rbf', probability=True, C=  3.251126178797826, gamma = 0.0034279054890762506, random_state=142, class_weight = 'balanced')
...
#           0      0.653     0.740     0.694       104
#           1      0.791     0.713     0.750       143
#    accuracy                          0.725       247
#   macro avg      0.722     0.727     0.722       247
#weighted avg      0.733     0.725     0.726       247
...
pl.savefig('SVM_ROC_bayesian_ElasticNet.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('SVM_prAUC_bayesian_ElasticNet.png', dpi = 2000)
