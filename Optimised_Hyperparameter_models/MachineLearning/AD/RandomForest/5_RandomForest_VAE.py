...
#Model #50
#Best pr-AUC: 0.6195
#Best params: OrderedDict([('max_depth', 13), ('min_samples_leaf', 1)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 13, min_samples_leaf = 1),
    search_spaces = {
...
#Model #100
#Best pr-AUC: 0.6113
#Best params: OrderedDict([('n_estimators', 1605)])


bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 13, min_samples_leaf = 1, n_estimators = 1605),
    search_spaces = {
        'min_samples_split': (2, 200, 'uniform')
    },    
    cv = StratifiedKFold(
        n_splits=5,
        shuffle = True,
...
#Model #20
#Best pr-AUC: 0.6241
#Best params: OrderedDict([('min_samples_split', 133)])



bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 13, min_samples_leaf = 1, n_estimators = 1605, min_samples_split = 133),
    search_spaces = {
...
#   Run the model
#####################
clf = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 13, min_samples_leaf = 1, n_estimators = 1605, min_samples_split = 133, max_features = 1)
...
#           0      0.620     0.471     0.536       104
#           1      0.673     0.790     0.727       143
#    accuracy                          0.656       247
#   macro avg      0.646     0.631     0.631       247
#weighted avg      0.651     0.656     0.646       247
