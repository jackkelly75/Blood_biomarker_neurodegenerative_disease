...
#Model #100
#Best pr-AUC: 0.7559
#Best params: OrderedDict([('C', 6.410836753079676), ('gamma', 2.8594305992584455e-05)])


#####################
#   Run the model
#####################
clf = SVC(kernel='rbf', probability=True, C= 6.410836753079676, gamma = 2.8594305992584455e-05, random_state=142, class_weight = 'balanced')
...
#           0      0.701     0.654     0.677       104
#           1      0.760     0.797     0.778       143
#    accuracy                          0.737       247
#   macro avg      0.731     0.726     0.727       247
#weighted avg      0.735     0.737     0.735       247
