...
#reduce the range of values, as was giving all results to once class in test
...
#Model #100
#Best pr-AUC: 0.8329
#Best params: OrderedDict([('C', 34.310224317710926), ('gamma', 0.00010753983888006124)])


#####################
#   Run the model
#####################
clf = SVC(kernel='rbf', probability=True, C=  34.310224317710926, gamma = 0.00010753983888006124,  random_state=142, class_weight = 'balanced')
...
#           0      0.724     0.731     0.727       104
#           1      0.803     0.797     0.800       143
#    accuracy                          0.769       247
#   macro avg      0.763     0.764     0.764       247
#weighted avg      0.770     0.769     0.769       247
...
pl.savefig('SVM_ROC_bayesian_VSSRFE_SVM.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('SVM_prAUC_bayesian_VSSRFE_SVM.png', dpi = 2000)
