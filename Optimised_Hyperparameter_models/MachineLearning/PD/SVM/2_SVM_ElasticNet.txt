...
bayes_cv_tuner = BayesSearchCV(
    ...
    search_spaces = {
        'C': (1e-7, 1e+5, 'log-uniform'),
        'gamma': (1e-7, 1e+1, 'log-uniform')
    },    
    cv = StratifiedKFold(
        n_splits=5,
        shuffle = True,
...
#Model #200
#Best pr-AUC: 0.8159
#Best params: OrderedDict([('C', 780.981553700027), ('gamma', 1.1170930522245284e-05)])


############
#	Run the model
############
clf = SVC(kernel='rbf', probability=True, C= 780.981553700027, gamma = 1.1170930522245284e-05, random_state=142, class_weight = 'balanced')
