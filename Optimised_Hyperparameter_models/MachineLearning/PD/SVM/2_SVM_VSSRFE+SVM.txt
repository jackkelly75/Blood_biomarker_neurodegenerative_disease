...
#Model #200
#Best pr-AUC: 0.792
#Best params: OrderedDict([('C', 1234.61750574153), ('gamma', 0.002278220488977483)])


############
#	Run the model
############
clf = SVC(kernel='rbf', probability=True, C= 1234.61750574153, gamma = 0.002278220488977483, random_state=142, class_weight = 'balanced')
...
#           0      0.632     0.632     0.632        68
#           1      0.603     0.603     0.603        63
#    accuracy                          0.618       131
#   macro avg      0.618     0.618     0.618       131
#weighted avg      0.618     0.618     0.618       131
...
pl.savefig('SVM_ROC_bayesian_VSSRFE+SVM.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('SVM_prAUC_bayesian_VSSRFE+SVM.png', dpi = 2000)
