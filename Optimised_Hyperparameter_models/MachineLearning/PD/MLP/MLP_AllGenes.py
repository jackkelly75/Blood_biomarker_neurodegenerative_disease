...
#{'activation': 'relu', 'alpha': 0.0001, 'hidden_layer_sizes': (15,), 'solver': 'adam'}
#0.5674141207166029
...
#	Run the model
############
clf = MLPClassifier(alpha = 0.0001, activation = 'relu', hidden_layer_sizes=(15, ), solver = 'adam', verbose=10,  random_state=10, max_iter = 10000, tol = 0.00001)
