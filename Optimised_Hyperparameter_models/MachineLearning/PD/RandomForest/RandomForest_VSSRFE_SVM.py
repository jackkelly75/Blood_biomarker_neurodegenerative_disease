...
bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 8, min_samples_leaf = 4),
    search_spaces = {
...
#Model #100
#Best pr-AUC: 0.7479
#Best params: OrderedDict([('n_estimators', 2022)])

bayes_cv_tuner = BayesSearchCV(
    estimator = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 8, min_samples_leaf = 4, n_estimators = 2022),
    search_spaces = {
        'min_samples_split': (2, 150, 'uniform'),
        'max_features': (1, 7, 'uniform')
    },    
    cv = StratifiedKFold(
        n_splits=5,
        shuffle = True,
...
#Model #50
#Best pr-AUC: 0.7536
#Best params: OrderedDict([('max_features', 1), ('min_samples_split', 41)])


############
#	Run the model
############
clf = RandomForestClassifier(random_state=10,  class_weight='balanced', max_depth = 8, min_samples_leaf = 4, n_estimators = 2022, max_features = 1, min_samples_split = 41)
...
#           0      0.657     0.676     0.667        68
#           1      0.639     0.619     0.629        63
#    accuracy                          0.649       131
#   macro avg      0.648     0.648     0.648       131
#weighted avg      0.649     0.649     0.649       131
...
pl.savefig('RandomForest_ROC_bayesian_VSSRFE_SVM.png', dpi = 2000)
...
pl.legend(loc="lower right")
pl.savefig('RandomForest_prAUC_bayesian_VSSRFE_SVM.png', dpi = 2000)
