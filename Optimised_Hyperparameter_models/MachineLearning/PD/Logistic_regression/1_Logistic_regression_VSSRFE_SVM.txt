...
#Model #200
#Best pr-AUC: 0.7781
#Best params: OrderedDict([('C', 7.344399164807348e-05)])


############
#	Run the model
############
clf = LogisticRegression(C =7.344399164807348e-05, random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
