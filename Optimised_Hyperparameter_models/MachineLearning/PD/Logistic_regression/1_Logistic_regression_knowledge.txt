...
#Model #200
#Best pr-AUC: 0.546
#Best params: OrderedDict([('C', 3.492567064053861e-05)])


############
#	Run the model
############
clf = LogisticRegression(C =3.492567064053861e-05, random_state=2,  class_weight='balanced', penalty='l2', solver='liblinear')
...
#           0      0.651     0.794     0.715        68
#           1      0.708     0.540     0.613        63
#    accuracy                          0.672       131
#   macro avg      0.679     0.667     0.664       131
#weighted avg      0.678     0.672     0.666       131
